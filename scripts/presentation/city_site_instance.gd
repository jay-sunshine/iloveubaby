...
@export var site_name: String = "City":
	set(value):
		site_name = value
		_update_label()

@export var site_type: String = "city"
@export var state_name: String = ""
@export var faction_id: String = ""
@export var site_scale: float = 22.0:
	set(value):
...
@export var label_height: float = 22.0:
	set(value):
		label_height = value
...
@export var collision_extents: Vector3 = Vector3(18.0, 9.0, 18.0):
	set(value):
...
func _rebuild_model() -> void:
	...
	if inst is Node3D:
		...
		_model_instance.rotation_degrees.y = _stable_rotation_deg(site_name)
		_model_root.add_child(_model_instance)
		_update_model_scale()

func _update_model_scale() -> void:
	if _model_instance != null:
		_model_instance.scale = Vector3.ONE * site_scale
...
func _update_collision_shapes() -> void:
	...
	if _selection_marker != null:
		...
		if mesh != null:
			mesh.top_radius = maxf(collision_extents.x, collision_extents.z) * 0.98
